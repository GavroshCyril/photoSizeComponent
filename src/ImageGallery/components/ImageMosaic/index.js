...
import { ArrowButton, Header } from "../CoolLightbox/components/Index";
...
const CoolLightbox = ({
  ...
  return (
    <StyledLightbox
      ...
      renderHeader={() => (
        <Header
          galleryTitle="Как 30 лет назад в Минске появилось метро"
          images={images}
          currentIndex={currentImageIndex}
          onClose={onClose}
        />
...
const StyledLightbox = styled(Lightbox)`npm te
  background: ${({ theme }) =>
